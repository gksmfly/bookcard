...
const Header: React.FC<HeaderProps> = ({ currentPage, onPageChange }) => {
  ...
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      title: '신간 도서 입고',
      message: '새로운 IT 도서 10권이 입고되었습니다.',
      date: '2024-02-11',
      isRead: false
    }
  ]);
  ...
  const [cartItems, setCartItems] = useState<CartItem[]>([
    { bookId: '1', addedDate: '2024-02-12' },
    { bookId: '2', addedDate: '2024-02-11' },
    { bookId: '4', addedDate: '2024-02-10' }
  ]);
  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button 
              ...
              className="relative p-2 text-blue-100 hover:text-white hover:bg-blue-500 rounded-lg transition-colors duration-200"
            >
      ...
      <CartPanel
        ...
        onProceedToRental={handleProceedToRental}
      />
    </header>
  );
};
